...
void adc_init() {
    ...
    ad7730_filter.fields.chp = 0; //no chopping (for lower noise and aliasing)
    ad7730_filter.fields.sf = ad7730_clk / 16 / adc_sample_rate;
...
void E_AD7730_nRDY_IRQHandler() {
    ...
    ad7730_data = SPI_send1(SPI_AD7730, 0);
